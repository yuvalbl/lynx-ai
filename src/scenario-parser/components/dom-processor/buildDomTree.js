// inspired by https://github.com/browser-use/browser-use/blob/main/browser_use/dom/buildDomTree.js
const buildDomTree = (
  args = {
  ...
  // TODO: either remove this, or add duration to the result, as in measureDomOperation
